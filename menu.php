...
<main>
    ...
    <section id="magellan-nav">
        <nav data-magellan-expedition="fixed">
            <dl class="sub-nav">
                <dd data-magellan-arrival="appetizers"><a href="#appetizers">Appetizers</a></dd>
                <dd data-magellan-arrival="salads"><a href="#salads">Salads</a></dd>
    ...
    <section id="appetizers">
        ...
        <div class="row item-row">
            ...
            <div class="medium-6 columns">
                <ul class="no-bullet">
                    <li><img src="/img/menu/pro-sampler.jpg" alt="Pro Sampler"></li>
    ...
    <section id="entrees">
        <div class="row">
            <div class="small-12 columns section-title">
                <a name="entrees"></a>
                <h2 data-magellan-destination="entrees">Entrees</h2>
            </div>
        </div>
        <div class="row">
            <div class="small-12 columns section-detail">
